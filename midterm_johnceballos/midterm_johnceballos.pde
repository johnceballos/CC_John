...
void draw(){
  if (state=="pregame"){
    ...
    h3x = (h3-40)*.7;
    theCircle(ax,ay,10);
    theCircle(a2x,a2y,10);
    theCircle(bx,by,10);
    theCircle(b2x,b2y,10);
    theCircle(cx,cy,10);
    theCircle(c2x,c2y,10);
    theCircle(dx,dy,10);
    theCircle(d2x,d2y,10);
    theCircle(ex,ey,10);
    theCircle(e2x,e2y,10);
    theCircle(fx,fy,10);
    theCircle(f2x,f2y,10);
    theCircle(gx,gy,10);
    theCircle(g2x,g2y,10);
    theCircle(hx,hy,10);
    thePlayer(X,Y,50);
    if (ay > 810){
        a1 = 5;
    ...
    if ((currentTime/60) > 20){
    theCircle(a3x,a3y,10);
    theCircle(c3x,c3y,10);
    theCircle(e3x,e3y,10);
    theCircle(g3x,g3y,10);
    }
    ...
    if ((currentTime/60) > 30){
      theCircle(b3x,b3y,10);
      theCircle(d3x,d3y,10);
      theCircle(f3x,f3y,10);
      theCircle(h3x,h3y,10);
    }
...
void keyPressed(){
  ...
  if (key=='w' && state=="oneplayer" && Y >= 55){
    Y=Y-30;
  }
   if (key=='a' && state=="oneplayer" && X >= 55){
    X=X-30;
  }
   if (key=='s' && state=="oneplayer" && Y <= 745){
    Y=Y+30;
  }
   if (key=='d' && state=="oneplayer" && X <=745){
    X=X+30;
  }
  if (key=='w' && state=="twoplayer" && Y1 >= 55){
    Y1=Y1-30;
  }
   if (key=='a' && state=="twoplayer" && X1 >= 55){
    X1=X1-30;
  }
   if (key=='s' && state=="twoplayer" && Y1 <= 745){
    Y1=Y1+30;
  }
   if (key=='d' && state=="twoplayer" && X1 <=745){
    X1=X1+30;
  }
  if (key=='i' && state=="twoplayer" && Y2 >= 55){
    Y2=Y2-30;
  }
   if (key=='j' && state=="twoplayer" && X2 >= 55){
    X2=X2-30;
  }
   if (key=='k' && state=="twoplayer" && Y2 <= 745){
    Y2=Y2+30;
  }
   if (key=='l' && state=="twoplayer" && X2 <=745){
    X2=X2+30;
  }
}
